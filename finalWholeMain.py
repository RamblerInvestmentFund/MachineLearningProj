...
X = np.array(frames[0].drop(columns = ["Signal", "Returns"], axis = 1))
...
Grid Search
After Running Grid Search, it found rbf, C=1000, and gamma=1 as best hyperparameters
...
#plt.figtext(.95,0.75, s="Sum Total Strat Returns "+'{0:.5g}'.format(frames[0]['Total Strat Returns'].sum()))
